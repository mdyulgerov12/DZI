...
Въпрос 17:  Дайте пример за for - цикъл в C#. За пример може да ползвате код, който отпечатва на конзолата числата от 1 до 100.
...
Въпрос 19:  Направо верния код  
   ...
   КЛЮЧ
         ...
         */
         ...
         Въпрос 20:  Компютърната програма е: 
         ...
         Въпрос 21: Даден е следният програмен код на C#. Открийте какъв ще бъде резултатът от изпълнението на програмата. В полето запишете очакваният резултат и защо  се е получил този резултат?
         ...
         Въпрос 22:  Дайте пример за конзолна програма, която чете оценка (десетично число), въведена от потребителя, и отпечатва “Excellent!”, ако оценката е 5.50 или по-висока, или “Not excellent.” в противен случай.
...

{
  ...
  Console.WriteLine("Not Excellent!");
         ...
         Въпрос 23:  Правилният отговор е: Поставете думите на празните места, така че да се получи правилно понятието за програмиране.
...
Въпрос 24: Дефинирайте понятието език за програмиране. 
...
Въпрос 25 : Решете задачата: Показан е следният програмен фрагмент на C#. Какви стойности трябва да се зададат на променливите age и gender, за да получим резултат "Ms."? 
...
Въпрос 26: Напишете метод на C#, който отпечатва на конзолата квадрат от звездички с размери nхn. Квадратът трябва да изглежда по следният начин:
...
Въпрос 27: Посочете как задаваме в C# пълната форма на условни конструкции? 
